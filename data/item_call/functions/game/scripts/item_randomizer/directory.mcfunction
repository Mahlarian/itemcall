...
# round 3 - 4
execute if score .round ic_gamedata matches 3..4 if score .pool_perc ic_gamedata matches 1..25 run function item_call:game/scripts/item_randomizer/pool_1
execute if score .round ic_gamedata matches 3..4 if score .pool_perc ic_gamedata matches 26..100 run function item_call:game/scripts/item_randomizer/pool_2
# round 5 - 7
