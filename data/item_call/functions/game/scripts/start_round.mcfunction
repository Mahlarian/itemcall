...
execute if score .choose ic_timers matches 176 run scoreboard players reset @a ic_vote
execute if score .choose ic_timers matches 176 run scoreboard players enable @a[tag=ic_player] ic_vote
